...
const FundingCard = ({ name,rate,location,image,plafon,tenor,remainingTime,id }) => {
    return (
        <Col>
            <Card className={styles.cardPartner}>
                <Card.Header className={styles.cardHeader}>
                    <Button variant="primary" className={styles.label}>Dibuka</Button>
                ...
                <Card.Body className={styles.cardBody}>
                    <div className={styles.padding}>
                        ...
                        <span className={styles.wrapper}>
                            ...
                            <Card.Text className={styles.locationText}>
                                {location}
                            </Card.Text>
                        </span>
                    </div>
                    ...
                    <div className={styles.padding}>
                        ...
                        <div className={styles.note}>
                            Sisa waktu {remainingTime} hari
                        </div>
                    </div>
                    <div className={styles.line} />
                    <div className={styles.padding}>
                        <div className={styles.center}>
                            <Button variant="primary" href={"/pendanaan/detail/" + id} className={styles.btn}>Lihat Pendanaan</Button>
                        </div>
                    </div>
                </Card.Body>
            </Card>
